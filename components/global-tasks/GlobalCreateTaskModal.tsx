        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          >
            ...
            <button
              onClick={handleClose}
              disabled={loading}
              className="absolute right-5 top-5 rounded-xl p-2 text-[#8a8a93] transition hover:bg-white/5 hover:text-white"
            >
              <X size={18} />
            </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-3">
                <button
                  ...
                  onClick={handleClose}
                  disabled={loading}
                  className="rounded-2xl border border-white/10 px-5 py-2.5 text-sm font-medium text-[#8a8a93] transition hover:bg-white/[0.05] hover:text-white disabled:opacity-50"
                >
                  Cancel
                </button>
                <button
