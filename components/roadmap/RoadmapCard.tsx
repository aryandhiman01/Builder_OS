...
export function RoadmapCard({ projectId, roadmap }: RoadmapCardProps) {
  ...
  return (
    ...
    >
        ...
        <div className="grid grid-cols-3 gap-2 pt-1 text-xs">
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5">
            ...
            <p className="mt-1 text-[11px] font-bold text-white font-mono">
              {roadmap.tokens ? roadmap.tokens.toLocaleString() : "—"}
            </p>
          </div>
          ...
          <div className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5">
            ...
            <p className="mt-1 text-[11px] font-bold text-white font-mono">
              {roadmap.generationTime ? `${roadmap.generationTime}s` : "—"}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="pt-4 mt-4 border-t border-white/10 relative z-10">
        <Link
          href={`/projects/${projectId}/roadmap/${roadmap.id}`}
          className="
          btn-shimmer
          flex
          w-full
