...
export default function RoadmapViewer({
  ...
  // Compute document metrics (word count, reading time, section headings)
  const metrics = useMemo(() => {
    const text = roadmap.content || "";
  ...
  function downloadMarkdown() {
    const blob = new Blob([roadmap.content], {
      type: "text/markdown;charset=utf-8;",
    });
    const url = URL.createObjectURL(blob);
    const link = document.createElement("a");
    link.href = url;
    link.download = `${roadmap.title.replace(/[^a-z0-9]/gi, "_")}.md`;
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 pb-24">
      ...
      <ConfirmModal
        ...
        description="Are you sure you want to delete this roadmap? This document will be permanently removed."
